...
//       <SheetTitle className="text-xl font-bold mb-4 text-primary">Buy Cheap </SheetTitle>
//       <Separator/>
              ...
              <PopoverContent className="w-[16rem] p-4 bg-white shadow-md rounded-md">
                <ul className='text-sm'>
                  {category.items.map((item) => (
                    <li key={item}>
                      <a href="#" className="block p-2 rounded hover:bg-gray-100">{item}</a>
                    </li>
                  ))}
                </ul>
              </PopoverContent>
